...
It looks like residual.sugar is not playing much role in determining the quality of wine, however high quality wines seems to have less amounts sugar.Now lets exlpore what sulfur dioxide is doing to the quality of wine. 
```{r}
...
it looks like sulfur dioxide doesn't have much effect on quality of wine because median and mean levels remain almost same over a wide range of quality of wines.As we know that density of wine depends upon the combination of liquids and residuals, so lets explore the relationship of density with alcohol and residual.sugar .
```{r}
