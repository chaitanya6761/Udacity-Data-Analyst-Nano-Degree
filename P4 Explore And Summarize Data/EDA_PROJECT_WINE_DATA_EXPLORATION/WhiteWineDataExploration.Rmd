 ...
 * Transformed the long-tailed data to better understand the distribution of residual.sugar. The transformed residual.sugar appears to be bimodal with two peaks. As mentioned in dataset description that it's rare to find wines with less than 1 gram/liter and wines with greater than 45 grams/liter are considered sweet.
```{r}
 ...
 * The plot is densely populated in some regions because the range of density values in wine dataset is very less. Now lets explore sulfur dixode content, As free.sulfur.dioxide is a subset of total.sulfur.dioxide, the below plot shows a strong relationship b/w them.
