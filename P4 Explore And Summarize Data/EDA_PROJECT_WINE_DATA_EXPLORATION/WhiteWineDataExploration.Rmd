...
As the mean and median of alcohol content initially seems to drop with quality upto 5, but increases after that till 9, so we can partially conclude that higher quality wines have a bit high amounts of alcohol on average.  
...
```
The graph seems to be densely populated in some regions because the density values have very less range(0.9871,1.0390). Now lets explore the relationship between density and alcohol.
```{r}
