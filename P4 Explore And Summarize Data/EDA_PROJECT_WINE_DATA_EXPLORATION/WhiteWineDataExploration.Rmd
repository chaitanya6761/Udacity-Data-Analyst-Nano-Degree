 ...
 * Transformed the long-tailed data to better understand the distribution of residual.sugar. The transformed residual.sugar appears to be bimodal with two peaks. As mentioned in dataset descripton that it's rare to find wines with less than 1 gram/liter and wines with greater than 45 grams/liter are considered sweet.
```{r}
 ...
 * Now Lets see the distribution free.sulfur.dioxide in ou dataset. It prevents microbial growth and the oxidation of wine
...
2. There is only one wine in the dataset which can be considered as sweet and there are 77 wines with residual suagr less than 1 gram/liter     which is a very rare property.
 ...
 * The relationship doesn't seem to be completely linear because of many different values of density for same range of residual.suagr, but we can say that its some what exponential. Now lets explore the relationship between density and alcohol.
 ...
 * The plot is densely populated in some regions because the range of density values in wine dataset is very less. Now lets explore sulfur dixode content, As free.sulfur.dioxide is a subset of total.sulfur.dioxide, the below plot shows a strong relationsip b/w them.
